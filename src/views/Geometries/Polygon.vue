...
export default {
  ...
  setup(props, context) {
    ...
    onBeforeMount(() => {})
    onMounted(() => {
      const viewer = new Cesium.Viewer('Polygon')
      ...
      //   polygon: {
      //     hierarchy: Cesium.Cartesian3.fromDegreesArrayHeights([-118.4, 40.4, 130000, -118.4, 37, 30000, -114.2, 38.0, 35000, -108.0, 37, 30000, -108.0, 40.4, 50000]),
      //     textureCoordinates: {
      //       positions: [new Cesium.Cartesian2(0, 1), new Cesium.Cartesian2(0, 0), new Cesium.Cartesian2(0.5, 0), new Cesium.Cartesian2(1, 0), new Cesium.Cartesian2(1, 1)]
      //     },
      ...
      //   polygon: {
      //     hierarchy: {
      //       positions: Cesium.Cartesian3.fromDegreesArrayHeights([-130, 40.0, 50000, -130, 36.0, 50000, -125, 37, 40000, -120, 36.0, 50000, -120, 40.0, 50000]),
      //       holes: [
      //         {
      //           positions: Cesium.Cartesian3.fromDegreesArrayHeights([-128, 39.2, 46000, -128, 38.6, 42000, -127, 38.6, 42000, -127, 39.2, 46000])
      //         }
      //       ]
      //     },
      //     textureCoordinates: {
      ...
      //       holes: [
      //         {
      //           positions: [new Cesium.Cartesian2(0.2, 0.8), new Cesium.Cartesian2(0.2, 0.6), new Cesium.Cartesian2(0.4, 0.6), new Cesium.Cartesian2(0.4, 0.8)]
      //         }
      //       ]
      //     },
      //     perPositionHeight: true,
      ...
      //   polygon: {
      //     hierarchy: Cesium.Cartesian3.fromDegreesArrayHeights([-90.0, 41.0, 0.0, -85.0, 51.0, 0.0, -80.0, 41.0, 0.0]),
      //     perPositionHeight: true,
      ...
      const purplePolygonUsingRhumbLines = viewer.entities.add({
        ...
        polygon: {
          hierarchy: Cesium.Cartesian3.fromDegreesArray([-120.0, 45.0, -80.0, 45.0, -80.0, 55.0, -120.0, 55.0]),
